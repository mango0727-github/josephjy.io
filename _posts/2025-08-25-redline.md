...
![Figure 1. PEStudio analysis result](https://github.com/mango0727-github/josephjy.io/blob/master/assets/img/redline/image1.png)

Figure 1. PEStudio analysis result

We also found that PEiD used the .NET framework, so we decided to utilize dnSpy.

![Figure 2. PEiD analysis result](assets/img/redline/image%201.png)
...
[Figure 3. File drop log on Procmon](assets/img/redline/image%202.png)

Figure 3. File drop log on Procmon

[Figure 4. Dropped files on the filesystem (NetFlix Checker by xRisky v2.exe dropped in the same location as the original file)](assets/img/redline/image%203.png)
...
[Figure 5. dnSpy decompilation result of the original file (encryption routine)](assets/img/redline/image%204.png)
...
[Figure 6. Decompilation result of original file on dnSpy (file drop and execution routine)](assets/img/redline/image%205.png)
...
[Figure 7. Deleting the code injection part for file extraction](assets/img/redline/image%206.png)
...
[Figure 8. Sample on the file system](assets/img/redline/image%207.png)
...
[Figure 9. Module cleanup part of Winlogon.exe dnSpy decompilation results](assets/img/redline/image%208.png)
...
[Figure 10. Identifying the C2 address](assets/img/redline/image%209.png)

Figure 10. Identifying the C2 address

[Figure 11.](assets/img/redline/image%2010.png)
...
[Figure 12. RemoteTask Action Definition](assets/img/redline/image%2011.png)
...
[Figure 13. Class definition for Cmd execution (1)](assets/img/redline/image%2012.png)

Figure 13. Class definition for Cmd execution (1)

[Figure 14. Class definition for Cmd execution (2)](assets/img/redline/image%2013.png)
...
[Figure 25](assets/img/redline/image%2024.png)

Figure 25

Browser (Chrome browser path and Gecko engine, blocked IPs, etc.), file, FTP, wallet, screen, Telegram, VPN, Steam, Discord, etc.

[Figure 26](assets/img/redline/image%2025.png)

Figure 26

[Figure 27](assets/img/redline/image%2026.png)

Figure 27

Hardware, host machine name, OS version, language, screen size, etc.

[Figure 28](assets/img/redline/image%2027.png)

Figure 28

[Figure 29](assets/img/redline/image%2028.png)

Figure 29

Country, city, time zone, IP address, monitor information, zip code, and various file locations.

[Figure 30](assets/img/redline/image%2029.png)

Figure 30

RAM information

[Figure 31](assets/img/redline/image%2030.png)

Figure 31

Display name

[Figure 32](assets/img/redline/image%2031.png)

Figure 32

Information about disk drives

[Figure 33](assets/img/redline/image%2032.png)

Figure 33

Process ID

[Figure 34](assets/img/redline/image%2033.png)
